...
public class DelegatingNavigationHandlerProxy extends NavigationHandler {
	...
	public void handleNavigation(FacesContext facesContext, String fromAction, String outcome) {
		...
		if (handler instanceof DecoratingNavigationHandler) {
			DecoratingNavigationHandler decHandler = (DecoratingNavigationHandler) handler;
			decHandler.handleNavigation(facesContext, fromAction, outcome, this.originalNavigationHandler);
		}
		else {
